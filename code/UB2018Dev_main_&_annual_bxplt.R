##############################################################################
#This first part creates standard CRSS Process plots to compare two CRSS runs
#This second part creates annual boxplots of Outflow and PE to compare two CRSS runs
...
setwd("C:/Users/cfelletter/Documents/Process-CRSS-Res")
...
getSysCondData <- TRUE #CF: must be true to get rwa_agg
getPeData <- TRUE
# typical figures
...
icMonth <- c("April 2018" = "18-Dec", "Asp.NoTribs" = "18-Dec")
